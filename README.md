...
Note that in <code>logs_exp_lev_0.0_thr_49.0</code> folder <code>lev</code> and <code>thr</code> means the mesh's level set and threshold used. to have that information you can check configs/scene.txt or when downloding, you will see a meshes folder with a mesh file named like <code>lev_0.0_thr_49.0_blender_paper_chair.ply</code>.
### 3. Training
